...
export function IconBuilding({ className = "h-4 w-4" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden>
      <path d="M4 21V5a1 1 0 011-1h5v17M14 21V9h5a1 1 0 011 1v11M9 7h1M9 11h1M9 15h1M17 13h1M17 17h1" />
    </svg>
  );
}

export function IconTarget({ className = "h-4 w-4" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden>
...
export function IconCards({ className = "h-4 w-4" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden>
      <rect x="3" y="4" width="14" height="16" rx="2" />
      <path d="M7 4V3a1 1 0 011-1h10a1 1 0 011 1v14" />
    </svg>
  );
}
...
export const TAB_ICONS: Record<string, ComponentType<{ className?: string }>> = {
  overview: IconHome,
